...
\f1\b0\fs24 \cf0 Set an environment variable pointing to the project root.\
In R:\
\pard\pardeftab720\partightenfactor0

\f2\fs26 \cf0 Sys.setenv(RAILD_ROOT = "/path/to/this/repo")\
\pard\pardeftab720\sa298\partightenfactor0
...
\f0\b\fs36 \cf0 Outputs\
\pard\pardeftab720\sa240\partightenfactor0

\f1\b0\fs24 \cf0 Figures and tables are written under 
\f2\fs26 out/
\f1\fs24  (exact subfolders depend on tags). Some scripts also write reproducibility logs (including 
\f2\fs26 sessionInfo()
\f1\fs24  and key input file metadata) under 
\f2\fs26 out/.../log/
\f1\fs24 .\
\pard\pardeftab720\sa298\partightenfactor0

\f0\b\fs36 \cf0 Supplementary files (manuscript submission + GitHub)\
\pard\pardeftab720\sa240\partightenfactor0
...
\f1\b0\fs24 \cf0 If you use this code or the released corpus definition, please cite the accompanying manuscript and the repository release (e.g., Zenodo DOI if available).\
}